...
const BrandLogoForm = ({ onBack, onContinue }) => {
  const [formData, setFormData] = useState({ logoName: '', logoDescription: '' });
  ...
  const handleContinue = () => {
    if (!formData.logoName.trim() || !formData.logoDescription.trim()) {
      alert('Please fill all fields before continuing.');
      return;
    }

    console.log('Logo submitted:', formData);

    // Call onContinue prop to move to Personalinfo
      ...
      <div className="flex flex-col sm:flex-row w-full max-w-5xl bg-[#f0f0f0] rounded-[2rem] shadow-xl overflow-hidden min-h-[600px]">
        ...
        <div className="w-full sm:w-2/5 flex flex-col justify-center px-12">
          <h1 className="text-5xl font-bold text-[#1a2b4b] leading-tight mb-2">
            Great! We can help protect your logo
          </h1>
          ...
          <div className="rounded-2xl shadow-xl w-full max-w-2xl p-8 lg:p-12">
            ...
            <div className="flex flex-col gap-2 mb-4">
              <label className="text-gray-700 font-bold">
                Enter the Logo you want to protect
              </label>
              <input
                name="logoName"
            ...
            <div className="flex flex-col gap-2 mb-4">
              ...
              <textarea
                ...
                placeholder="A brief description of your logo"
              />
            </div>

            {/* Help Link */}
            <button className="flex items-center gap-2 text-[#004c82] text-sm font-semibold mb-4">
              <HelpCircle size={18} />
            ...
            <div className="flex items-center gap-4 mt-8">
              {/* <-- Back button now calls onBack prop */}
              <button
                onClick={onBack}
